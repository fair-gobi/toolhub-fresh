    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-2">16 Free Online Tools</p>
          <p className="text-gray-500">EMI • Tax Nepal • Currency • Crypto • QR • GPA • Date Converter</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Link href="/finance-tools" className="group p-8 bg-white rounded-2xl shadow-sm border hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600 text-sm">EMI, Compound Interest, Tax, Currency, Crypto, 11 calculators</p>
          </Link>
          ...
          <Link href="/nepal-tools" className="group p-8 bg-white rounded-2xl shadow-sm border hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600 text-sm">Date converter BS↔AD, GPA calculator, local utilities</p>
          </Link>
        </div>

        <div className="mt-16 text-center text-sm text-gray-500">
          <p>© 2026 promptoolhub.com • Fast • Free • No signup</p>
        </div>
      </div>
    </main>
  );
